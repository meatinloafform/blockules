...
{
    [AutoloadBossHead]
    public class WhiteTriangle : ModNPC
    {
        ...
        private void Spin()
        {
            ...
            else if (floatTimer >= 100)
            {
                if (floatTimer < 150)
                {
                    ...
                    Projectile.NewProjectile(npc.position.X,npc.position.Y, rnd.Next(-3, 3),10, mod.ProjectileType("WhiteTriangleProjectile"), 5, 3,Main.myPlayer);
